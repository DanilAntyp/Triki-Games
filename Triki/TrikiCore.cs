...
namespace TrikiReader
{
    public sealed class TrikiBleReader
    {
        ...
        /// <summary>
        /// Raised on the BLE thread with the raw bytes of every incoming notification, before any
        /// frame parsing. Additive/diagnostic only: lets callers inspect packets the 14-byte IMU
        /// parser would otherwise drop (e.g. to hunt for an undocumented button field). Never
        /// touch the UI directly from this handler.
        /// </summary>
